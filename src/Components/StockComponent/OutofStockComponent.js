...
function OutOfStockComponent() {
  ...
  const productsPerPage = 3; // You can adjust the number of cards per page
          ...
          <div className="oos-product-list">
            {currentProducts.map(stock => (
              <div key={stock.productId} className="oos-product-card">
                <h4 className="oos-product-id">Product ID: {stock.productId}</h4>
                <p className="oos-product-info">
                  <strong className="oos-bold-text">Product Name:</strong> {stock.productName}
                </p>
                <p className="oos-product-info">
