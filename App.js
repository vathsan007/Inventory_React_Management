    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="/profile/acc" element={<AccountComponent />} />
          <Route path="/profile/loggedout" element={<LogoutComponent onLogout={handleLogout} />} />
          ...
          <Route path="/product/filter" element={<FilterProductsComponent/>}/>



          <Route path="/reports/sales-report" element={<SalesReport />} />
          <Route path="/reports/stock-level" element={<StockLevelReport />} />
          <Route path="/reports/user-order-details" element={<UserOrderReport />} />
